...
<html>
    <head>
        <title>Sheridan - My Semester</title>
        <meta charset="UTF-8">
    ...
    <body>
        ...
        <nav class="card hideForPrint">
            ...
            <button onclick="showHelp()" title="Display the help documentation">Help</button>
            ...
            */
            ...
            function newSemester(bypassPrompt = false){
                ...
                if (bypassPrompt || confirm(warningText)) {
                    ...
                    semester = new SemesterPlan('', new Date(1600056000000), new Date(1608267600000), new Date(1603684800000));
